...
const doctors = [
  {
    ...
    description: 'Traumatologista com pós-graduação em Cannabis Medicinal e especialização em medicina integrativa.',
  ...
  },
  {
    ...
    description: 'Ortopedista e traumatologista, prescritor de cannabis desde 2018 com mais de 4 mil pacientes.',
